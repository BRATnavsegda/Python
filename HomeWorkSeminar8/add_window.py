...
def calculate():
    global window
    data = (window.children['frame'].children['frame_fio'].get() +
            ' / ' + window.children['frame'].children['frame_tel_number'].get() +
            ' / ' + window.children['frame'].children['frame_job_title'].get() +
            ' / ' + window.children['frame'].children['frame_age_entry'].get() +
            ' / ' + window.children['frame'].children['frame_salary'].get()).replace(',', '.')
    # a = window.children['frame'].children['frame_fio'].get()
    # print(type(a), a)
...
def get_value():
    ...
    mainframe = ttk.Frame(window, padding="100 50 50 50", name="frame")
    ...
    feet_fio = StringVar()
    feet_fio_entry = ttk.Entry(mainframe, width=50, textvariable=feet_fio, name="frame_fio")
    ...
    feet_tel_number_entry = ttk.Entry(mainframe, width=50, textvariable=feet_tel_number, name="frame_tel_number")
    ...
    feet_job_title_entry = ttk.Entry(mainframe, width=50, textvariable=feet_job_title, name="frame_job_title")
    ...
    feet_age = StringVar()
    feet_age_entry = ttk.Entry(mainframe, width=50, textvariable=feet_age, name="frame_age_entry")
    ...
    feet_salary_entry = ttk.Entry(mainframe, width=50, textvariable=feet_salary, name="frame_salary")
